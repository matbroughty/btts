...
<%
    ...
    if (choices.isEmpty()) {
        ...
        for (Entity choice : choices) {
            ...
            playerTable.append("<td>").append(BTTSHelper.entityPropertyAsNumber(choice.getProperty("choice1Points"))).append("</td>");
            ...
            playerTable.append("<td>").append(BTTSHelper.entityPropertyAsNumber(choice.getProperty("choice2Points"))).append("</td>");
            ...
            playerTable.append("<td>").append(BTTSHelper.entityPropertyAsNumber(choice.getProperty("choice3Points"))).append("</td>");
            ...
            playerTable.append("<td>").append(BTTSHelper.entityPropertyAsNumber(choice.getProperty("choice4Points"))).append("</td>");
